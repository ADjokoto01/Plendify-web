import { Card, SimplePagination, Text, Loader } from "@/components";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export function BeautyAndCosmeticsPage() {
  ...
  const { data: subCategories } = useFindSubCategories(category || "");
      ...
      <div className="max-w-[1000px] w-full">
        <section className="flex items-end gap-2">
          ...
          <Text variant="span" weight="normal" className="text-grey-100">
            {allProducts?.pagination?.totalPages || 0}
          </Text>
        </section>
        <Text variant="p" weight="normal">
          Beauty and cosmetics encompass skincare, makeup, and personal care
          products designed to enhance appearance, promote self-care, and boost
          confidence.
        </Text>
      </div>
